...
def parse_Pappas_patient_file(filename):
...
def main():
  filename = 'data/Pappas_StemAbList.tsv'
  patientID = "Single"
  outfile_HD39  = 'result/HD39_Pappas_Patient_summary.tsv'
  outfile_Dgene = 'result/Dgene_Pappas_Patient_summary.tsv'
  ...
  Dgene_dict = parse_Pappas_patient_file(filename)
